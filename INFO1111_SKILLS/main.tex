...
\textbf{3. Commit the changes}
\begin{verbatim}
git commit -m "Kaffa submit tex inclue Step GIT"
\end{verbatim}
Save your changes with a meaningful commit message.

\begin{center}
\includegraphics[width=0.8\textwidth]{kaffa/clone.png}
\captionof{figure}{Committing changes}
\end{center}

\textbf{4. Push to the remote repository}
\begin{verbatim}
git push
\end{verbatim}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{kaffa/clone.png}
\captionof{figure}{Pushing to GitHub}
\end{center}

\textbf{5. Pull updates from remote}
\begin{verbatim}
git pull origin main
\end{verbatim}
Fetch and merge the latest changes from the remote \texttt{main} branch.

\begin{center}
\includegraphics[width=0.8\textwidth]{kaffa/clone.png}
\captionof{figure}{Pulling updates}
\end{center}
