...
Our team consisted of four members from different computing majors: Computer Science, Data Science, Software Development, and Cyber Security. The primary objective of this project was to practice collaborative skills using GitHub rather than developing a complete solution. We effectively utilized GitHub's issue tracking to divide and allocate tasks based on our individual specialties. This clearly defined responsibility helped foster cross-disciplinary support; for instance, the Software Development member assisted the Cyber Security member with coding challenges, and the Data Science member guided the team in data-related tasks.  

One key challenge we encountered involved writing documentation in LaTeX. Initially, we wrote LaTeX code directly without real-time PDF previews, resulting in frequent compilation errors due to overlooked syntax issues. To resolve this, we transitioned to using Visual Studio Code with LaTeX extensions, providing an Overleaf-like live PDF preview. This significantly enhanced our efficiency, allowing us to immediately identify and rectify errors.

Overall, by addressing challenges collaboratively and leveraging appropriate tools like GitHub and VS Code, we greatly improved our team's communication, task management, and productivity.
...
\captionof{figure}{Generating PDF using Git terminal}
\end{center}
